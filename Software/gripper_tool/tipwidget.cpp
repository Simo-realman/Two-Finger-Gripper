...
void TTipWidget::SetMesseage(const int type, const QString &strMessage, const QPoint *pPoint)
{
    ...
    if(type == TIPINFO) {
        setStyleSheet(QString("color:white;font:12px \"Microsoft YaHei\";border-radius:2px;background-color:rgb(0,128,0);"));
    } else if(type == TIPWARRING) {
        setStyleSheet(QString("color:white;font:12px \"Microsoft YaHei\";border-radius:2px;background-color:rgb(255,215,0);"));
    } else if(type == TIPERROR) {
        setStyleSheet(QString("color:white;font:12px \"Microsoft YaHei\";border-radius:2px;background-color:rgb(220,20,60);"));
    }
    setVisible(true);
