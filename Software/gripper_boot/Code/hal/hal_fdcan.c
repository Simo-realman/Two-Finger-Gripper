...
void __hal_fdcan1_init(void (*_cb)(FDCAN_RxHeaderTypeDef *, uint8_t *))
{
  ...
  /* USER CODE BEGIN FDCAN1_Init 2 */
	...
	sFilterConfig.FilterID1 = 0x1;                               	//32位ID
...
//	//广播帧
//	sFilterConfig.FilterIndex = 1;                                //滤波器索引
//	sFilterConfig.FilterID1 = 0x0f;                               	//32位ID
//	sFilterConfig.FilterID2 = 0x00f;                              //如果FDCAN配置为传统模式的话，这里是32位掩码
//	if(HAL_FDCAN_ConfigFilter(&hfdcan1, &sFilterConfig) != HAL_OK) //滤波器初始化
//	{
//			Error_Handler();
//	}
